...
public class SelectMenuButtonsController : MonoBehaviour {
	...
	void Start () {
		...
		prevEnabled = progMan.isRepetitionLevelAvailable ();
		//Debug.Log ("Repetition available: " + prevEnabled.ToString ());
